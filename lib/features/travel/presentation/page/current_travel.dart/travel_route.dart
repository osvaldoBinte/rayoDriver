...
import 'package:rayo_taxi/features/travel/presentation/page/current_travel.dart/emergency/emergency_button.dart';
...
Row(
  ...
  child: EmergencyButton(),
     ...
     // Reemplaza el botón de navegación existente con este código actualizado
      ...
      onPressed: controller.isLoadingNavigation.value 
        ...
        : () async {
            if (widget.travelList[0].id_status == 3) {
              await controller.launchNavigationToStart();
            } else {
              await controller.launchNavigationToDestination();
            }
          },
      style: ElevatedButton.styleFrom(
        backgroundColor: Theme.of(context).colorScheme.buttonColormap,
